...
class UNet3D(AbstractUNet):
    ...
    def __init__(self, in_channels = 1, out_channels = 1, final_sigmoid=True, f_maps=32, layer_order='gcr',
                 num_groups=4, num_levels=3, is_segmentation=True, conv_padding=1,
