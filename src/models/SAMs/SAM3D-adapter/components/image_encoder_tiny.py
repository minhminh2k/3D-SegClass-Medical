...
class TinyImageEncoderViT_3d(nn.Module):
    def __init__(
            self,
            img_size: int = 1024,
            patch_size: int = 16,
        ...
        for i in range(len(depth)):
            block = Block_3d(
                ...
                res_size=window_size[i], # if i not in global_attn_indexes else img_size // patch_size,
