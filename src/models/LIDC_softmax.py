...
class LIDC_Module_Softmax(LightningModule):
    ...
    def __init__(
        ...
        self.train_hd = HausdorffDistanceMetric(include_background=False, reduction=MetricReduction.MEAN, percentile=95)
        self.val_hd = HausdorffDistanceMetric(include_background=False, reduction=MetricReduction.MEAN, percentile=95)
        self.test_hd = HausdorffDistanceMetric(include_background=False, reduction=MetricReduction.MEAN, percentile=95)
    ...
    def training_step(
        ...
        _ = self.train_dice(y_pred=outputs_convert, y=labels_convert)
        _ = self.train_jaccard(y_pred=outputs_convert, y=labels_convert)
        _ = self.train_hd(y_pred=outputs_convert, y=labels_convert)
    ...
    def validation_step(self, batch: Tuple[torch.Tensor, torch.Tensor], batch_idx: int) -> None:
        ...
        _ = self.val_dice(y_pred=outputs_convert, y=labels_convert)
        _ = self.val_jaccard(y_pred=outputs_convert, y=labels_convert)
        _ = self.val_hd(y_pred=outputs_convert, y=labels_convert)
    ...
    def test_step(self, batch: Tuple[torch.Tensor, torch.Tensor], batch_idx: int) -> None:
        ...
        _ = self.test_dice(y_pred=outputs_convert, y=labels_convert)
        _ = self.test_jaccard(y_pred=outputs_convert, y=labels_convert)
        _ = self.test_hd(y_pred=outputs_convert, y=labels_convert) 
