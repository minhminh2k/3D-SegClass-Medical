...
def evaluate(cfg: DictConfig) -> Tuple[dict, dict]:
    ...
    dataset = LIDC_IDRI_2D_Dataset(file_nodule_list[patient_number], file_clean_list, mode="train", img_size=[256, 256])
    ...
    predictions = trainer.predict(model=model, dataloaders=dataloaders, ckpt_path=cfg.ckpt_path) # list
