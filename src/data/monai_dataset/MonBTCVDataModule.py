...
from .components.btcv_dataset import BTCV_Dataset
...
class MonBTCVDataModule(LightningDataModule):
    ...
    def __init__(
        self,
        data_dir: str = "/data/hpc/dqm/data/RawData",
        datalist_json: str = '/data/hpc/dqm/3D-SegClass-Medical/preprocess_data/swin-unetr/btcv/dataset_0.json',
        train_val_test_split: Tuple[float, float, float] = (0.75, 0.125, 0.125),
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            ...
            train_files = load_decathlon_datalist(self.hparams.datalist_json, True, "training")
            val_files = load_decathlon_datalist(self.hparams.datalist_json, True, "validation")
            ...
            self.data_train = BTCV_Dataset(data_dir=self.hparams.data_dir, data_list=train_data, transform=self.hparams.transform_train)
                        
            # Transform Val
            self.data_val = BTCV_Dataset(data_dir=self.hparams.data_dir, data_list=val_data, transform=self.hparams.transform_val)
