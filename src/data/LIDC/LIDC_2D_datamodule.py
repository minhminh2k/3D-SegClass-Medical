...
from src.data.LIDC.components.LIDC_2D_transform import LIDC_IDRI_2D_Transform


class LIDC_IDRI_2D_DataModule(LightningDataModule):
    def __init__(
        self,
        nodule_dir: str = "/data/hpc/dqm/segment_data/Image",
        clean_dir: str = "/data/hpc/dqm/segment_data/Clean/Image",
        ...
        self.data_train = LIDC_IDRI_2D_Dataset(nodule_train, clean_train, mode="train", img_size=self.hparams.img_size)

        self.data_val = LIDC_IDRI_2D_Dataset(nodule_val, clean_val, mode="valid", img_size=self.hparams.img_size)

        self.data_test = LIDC_IDRI_2D_Dataset(nodule_test, clean_test, mode="test", img_size=self.hparams.img_size)

        # Transform
        self.data_train = LIDC_IDRI_2D_Transform(self.data_train, transform=self.hparams.transform)

        self.data_val = LIDC_IDRI_2D_Transform(self.data_val, transform=self.hparams.transform)

        self.data_test = LIDC_IDRI_2D_Transform(self.data_test, transform=self.hparams.transform)
